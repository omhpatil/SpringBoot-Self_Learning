...
//    {
//    	  "firstName": "Om",
//    	  "lastName": "Patil"			you have write this data inside RAW -> JSON and click on send it will show Hello, Om Patil in Response 
//    }
    ...
    // There is no need of extra data you can simply write your name in URL and it will show Hello, Om Patil in response
    ...
    // Choose headers in that write key:token and value:1234
        @GetMapping("/header")
